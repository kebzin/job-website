            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <h3 className="mb-4 text-3xl font-bold  sm:text-4xl">
                  Hmm. We’re having trouble Featching Your Data
                </h3>
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  We were unable to connect to the server : Network Error
                </p>
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  Please Check your network connection it might be you are
                  offline
                </p>
                <div className="flex items-center  justify-center gap-4 flex-wrap">
                  <Button variant="" className=" py-6" onClick={() => reset()}>
                    {" "}
                    Try again
                  </Button>
                  <Button
                    className=" py-6 bg-primary/40"
                    onClick={() => router.push("/")}
                  >
                    Back to Home
                  </Button>
